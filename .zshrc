...
# hide “user@hostname” info when you’re logged in as yourself on 
# your local machine
# DEFAULT_USER="user"
...
# Use config stored in ~/.config/lazyvim and not ~/.config/nvim
...
tvim() {
    NVIM_APPNAME=texvim
    #echo "Starting $NVIM_APPNAME"
    ~/personal/neovim/build/bin/nvim
}
